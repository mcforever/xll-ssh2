...
function goSave(){
	if(confirm("是否保存？")){
		...
		if(teacherName.value.trim() == null || teacherName.value.trim() == ""){
			alert("教师姓名不能为空");
			classesName.focus();
			return false;
		}
...
<form id="form1" name="form1" action="" method="post">
		...
		<tbody>
			<tr>
				<td noWrap background="images/img/th_bg.gif" height="25">
					<font color="#ffffff"><strong>编辑教师信息</strong></font>
				</td>
			</tr>
			<tr>
	...
	<table align="center" cellspacing="1" cellpadding="0" border="0" width="100%" height="100%">
		<tr>
			<td nowrap align="center">教师姓名：<input type="text" name="teacher.teacherName" id="teacherName" value="${teacher.teacherName }"/></td>
		</tr>
		<tr>
